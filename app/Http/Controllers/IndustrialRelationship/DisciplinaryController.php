...
class DisciplinaryController extends Controller
{
    ...
    /**
     *@method to create disciplinary case
     */
    // public function  disciplinaryInitatiation(Request $request, $id =  null)
    // {

    //     $validator = Validator::make($request->all(), [
    //         'disciplinary_cause' => 'required|max:5',
    //         'firstname' => 'required|max:191',
    //         'lastname' => 'required|max:191',
    //         'disciplinary_date' => 'required|max:191',
    ...
    //         $disciplinaries = $this->disciplinaries->disciplinaryInitatiation($request, $id);

    //         $status = $disciplinaries->getStatusCode();

    //         if ($status === 200) {
    //             // log::info('ndani');
    //             $return = [
    //                 'status' => 200,
    //                 "message" => "disciplinary successfully created.",
    //             ];
    //         } else {
    //             $return = [
    //                 'status' => 500,
