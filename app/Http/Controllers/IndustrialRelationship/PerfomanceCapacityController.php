...
use App\Repositories\IndustrialRelationship\PerfomanceCapacityRepository;

class PerfomanceCapacityController extends Controller
{
 protected $capacity;

    public function __construct(PerfomanceCapacityRepository $capacity)
    {
...
public function retrieveEmployeeDetail($id){
       ...
       $employee =  $this->capacity->retrieveEmployeeDetails($id);
...
public function  createPerfomanceCapacity(Request $request)
{
            ...
            'incapacity_type' => 'required|max:5',
