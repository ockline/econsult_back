...
class CompetencyInterview extends Model
{
  use SoftDeletes;
    ...
    protected $fillable = [
        ...
        'work_site', 'reallocation_place','recruiter_recommendations','recommended_title','interview_number','candidate_name','ranking_creterial_id','core_competence_id','core_remark','functional_competence_id','functional_remark','status','mgt_senior_competence_id','mgt_senior_remark','mgt_top_competence_id','mgt_top_remark','downloaded','uploaded','surgery_operation','uploaded_date','surgery_operation_remark', 'criminal_bureau'
