...
class PaternityRepository extends  BaseRepository
{
    ...
    public function __construct(AllLeave $partenity)
    {
        $this->partenity = $partenity;
    }
    ...
    {
        $partenitys = $this->partenity->where("id", $id)->first();

        if (!is_null($partenitys)) {
            return $partenitys;
        }
    ...
    {
        $partenitys = $this->partenity->get();
        return $partenitys;
    }
    /**
     *@method to save annual leave paid according to  leave type
     */
    public function savePaternityLeave($request)
    {
        ...
        try {
            ...
            $all_balance = $this->allBalanceDays($request);
                ...
                $data = [
                    'leave_type_id' => !empty($request->leave_type) ? $request->leave_type : 4,
     ...
     */
    public function getPaternityLeave()
    {
        ...
        /**
     *@method to update annual leave paid according to  leave type
     */
    public function updatePaternityLeave($request, $id)
    {
 ...
 */
public function retrievePaternityLeaveDetails($leaveId)
{
