...
class PerfomanceCapacityRepository extends  BaseRepository
{
    // use  FileHandler, AttachmentHandler, DefaultTrait;


    const MODEL = PerformanceCapacity::class;


    protected $capacity;


    public function __construct(PerformanceCapacity $capacity)
    {
