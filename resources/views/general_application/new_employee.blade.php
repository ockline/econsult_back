...
<head>
    ...
    <title>{{strtoupper('NEW EMPLOYEE APPLICATION FORM (Main Contractor Staff)')}}</title>
    <style>
        body {
            font-size: 13px;
        ...
        <table style="width: 95%;font-size: 13px;font-family: 'Bookman Old'; border: none">
            <tbody>
                <tr>
                    ...
                    <td style="border: none solid #333; font-family: 'Bookman Old'; font-size: 17px; color: #6899e7"><b>NEW EMPLOYEE APPLICATION FORM (Main Contractor Staff)</td>
                </tr>
                <tr>
                    <td style="border: none solid #333; font-family: 'Bookman Old'; font-size: 14px; color: #6899e7"><b>Personal Information:</b></td>
                </tr>
                <tr>
                ...
                <br />
                <tr>
                    <td style="border: none solid #333; font-family: 'Bookman Old'; font-size: 14px; color: #6899e7; "><b>Employment Details:</b></td>
                </tr>
                <tr>
                    <td style="text-align: left;border: none"><b>Company Name</b>: <span style="display: inline-block; width: 350px; border-bottom: 1px solid black;"> {{ $employee->employer}}</span></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td style="text-align: leftl; border: none"><b>Emergency Contact Name & Number </b>: <span style="display: inline-block; width: 350px; border-bottom: 1px solid black;">{{$employee->emergency_contact_name}} </span>&nbsp; - &nbsp; <span style="display: inline-block; width: 350px; border-bottom: 1px solid black;"> {{$employee->emergency_contact_number }} </span>
                    </td>
                </tr>
                <br />
                <tr>
                ...
                <tr>
                    <td style="text-align: left; border: none"><b>Manager`s Name</b>: <span style="display: inline-block; width: 350px; border-bottom: 1px solid black;"> {{ $employee->manager_name }} </span>
                    </td>
                </tr>
                <tr>
