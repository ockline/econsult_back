...
<head>
    ...
    <title>{{strtoupper('VISITOR APPLICATION FORM')}}</title>
    <style>
        body {
            font-size: 13px;
        ...
        <table style="width: 95%;font-size: 13px;font-family: 'Bookman Old'; border: none">
            <tbody>
                <tr>
                    ...
                    <td style="border: none solid #333; font-family: 'Bookman Old'; font-size: 17px; color: #6899e7"><b>VISITOR APPLICATION FORM</td>
                </tr>
                <tr>
