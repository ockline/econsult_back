...
<head>
    ...
    <title>{{strtoupper('TEMPORARY SITE ENTRY FORM')}}</title>
    <style>
        body {
            font-size: 13px;
        ...
        <table style="width: 95%;font-size: 13px;font-family: 'Bookman Old'; border: none">
            <tbody>
                <tr>
                    ...
                    <td style="border: none solid #333; font-family: 'Bookman Old'; font-size: 17px; color: #6899e7"><b>TEMPORARY SITE ENTRY FORM</td>
                </tr>
                <tr>
                    <td style="border: none solid #333; font-family: 'Bookman Old'; font-size: 14px; color: #6899e7"><b>Visitor’s Details:</b></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td style="text-align: left;border: none"><b>Organization</b>: <span style="display: inline-block; width: 350px; border-bottom: 1px solid black;"> {{ $employee->organization}}</span></td>
                </tr>
                <tr>
                    <td style="text-align: left; border: none"><b>Purpose of Visit: </b>: <span style="display: inline-block; width: 350px; border-bottom: 1px solid black;">{{ $employee->purpose }}</span></td>
                </tr>
                <tr>
                    <td style="text-align: leftl; border: none"><b>Entry Date & Time: </b>: <span style="display: inline-block; width: 350px; border-bottom: 1px solid black;">{{$employee->from_date}} </span>&nbsp; - &nbsp; <b>Expected Exit Date & Time: </b><span style="display: inline-block; width: 350px; border-bottom: 1px solid black;"> {{$employee->to_date }} </span>
                    </td>
                </tr>
                <tr>
                ...
                <br />
                <tr>
                    <td style="border: none solid #333; font-family: 'Bookman Old'; font-size: 14px; color: #6899e7; "><b>Host’s Details:</b></td>
                </tr>
                <tr>
                    <td style="text-align: left; border: none"><b>Host Name </b>: <span style="display: inline-block; width: 350px; border-bottom: 1px solid black;"> {{ $employee->host_name }} </span></td>
                </tr>
                ...
                <tr>
                    <td style="text-align: left; border: none"><b>Contact Number: </b>: <span style="display: inline-block; width: 350px; border-bottom: 1px solid black;">{{ $employee->Contact_number }} </sapn>
                    </td>
                </tr>
                ...
                <tr>
                    <td style="text-align: left; border: none"><b>Security Officer</b>: <span style="display: inline-block; width: 350px; border-bottom: 1px solid black;"> {{ $employee->security_officer }} </span>
                    </td>
                </tr>
                <tr>
